...
function AppLayout() {
  ...
  const displayUrl = `https://www.your-next-web-developer.dev${location.pathname}`;
  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="relative w-full sm:w-[80%] max-w-[1700px] overflow-hidden border-3 border-gray-800 bg-gray-100 rounded-lg sm:rounded-xl shadow-[5px_5px_0px_0px_rgba(31,41,55)] sm:shadow-[10px_10px_0px_0px_rgba(31,41,55)]">

          {/* Traffic lights bar */}
          <div className="flex items-center h-10 bg-gray-200 border-b-2 border-gray-800 px-4">
            <div className="flex gap-2">
              <div className="w-3 h-3 rounded-full bg-red-500 border border-gray-800" />
              <div className="w-3 h-3 rounded-full bg-yellow-500 border border-gray-800" />
              <div className="w-3 h-3 rounded-full bg-green-500 border border-gray-800" />
            </div>
          </div>
          ...
          <div className="p-4 sm:p-6 lg:p-10 bg-white">
            <div className="grid grid-cols-1 lg:grid-cols-[3fr_2fr] gap-4 sm:gap-6 w-full">
              ...
              >
                <div
                  className="w-full max-w-[800px] overflow-y-auto p-4 sm:p-6 md:px-8 rounded-xl no-scrollbar"
                  style={{ height: 'clamp(300px, calc(100vh - 330px), 780px)' }}
                >
                  <Routes>
